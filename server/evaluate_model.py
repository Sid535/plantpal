...
from model_config import (
    ...
    PLANT_CONFIG, MODEL_PATHS
)

def evaluate(plant: str):
    ...
    plot_path = str(ROOT / "server" / "reports" / "confusion_matrix" / f"{training_model_name}_confusion_matrix.png")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate a PlantPal model")
    parser.add_argument(
        "--plant",
        required=True,
        choices=PLANT_CONFIG.keys(),
        help="Which plant model to evaluate"
    )
